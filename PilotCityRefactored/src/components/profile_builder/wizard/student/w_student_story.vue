<template>
  <div class="container">
    <h4 class="font-weight-bold">
      ...
      <div class="d-flex flex-row justify-content mr-5">
      ...
      <div class="d-flex flex-row justify-content-left mr-5">
        ...
        <div class="p-2 align-self-start">
          <input
            ...
            class="badge-pill pc-button"
            v-model="student_data.school_name"
          >
        </div>
        <div class="p-2 align-self-center">
        ...
        <input
          ...
          class="badge-pill pc-button"
          v-model="student_data.school_district"
        >
    ...
    <next_button route="w_student_demographic" :conditions="conditions" :collection="collection"/>
  </div>
</template>
