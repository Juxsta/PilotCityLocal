    ...
    <div class="row justify-content-left mr-5 pb-4">
      <div class="col-md-4 col-sm-12">
        <form>
          <div>
            ...
            <br>
            <input type="date" name="birthday" placeholder="MM/DD/YYY" class="badge-pill pc-button" v-model="Birthdate">
          </div>
        </form>
      </div>
      ...
      <form>
        <div class="badge_wider">
          ...
          <br>
          <input type="text" name="address" placeholder="123 Main Rd" class="badge-pill pc-button badge_wider">
        </div>
      </form>
      </div>
    </div>
    ...
    <div class = "col-md-4 col-sm-12">
      <form>
        <div>
          ...
          <br>
          <input type="text" name="Ethnicity" placeholder="American" class="badge-pill pc-button">
        </div>
      </form>
    </div>
    <div class = "col-md-4 col-sm-12">
      <form>
        <div class="group labels">
          ...
          <br>
          <input type="text" name="Yes/No" placeholder="Spanish" class="badge-pill pc-button">
        </div>
      </form>
    </div>
    <div class = "col-md-4 col-sm-12">
    ...
    <div class = "col-md-4 col-sm-12">
      <form>
        <div class="group labels">
          ...
          <br>
          <input type="text" name="Yes/No" placeholder="Yes/No" class="badge-pill pc-button">
        </div>
      </form>
    </div>
    </div>
