            ...
            <form>
              <div class="col-auto form-margin">
                <div class="input-group mb-2 padding">
                  ...
                  <input
                    type="email"
                    class="form-active form_active_login"
                    id="login-input-username"
                    placeholder="Enter Email"
                    v-model="login_input_username"
                  >
                </div>
              </div>
              <div class="col-auto form-margin">
...
export default {
  ...
  methods: {
    login: function() {
      ...
      firebase
        ...
        .signInWithEmailAndPassword(
          this.login_input_username,
          this.login_input_password
        )
        .then(cred => {
          if (
            testEnv &&
            ...
            if (this.$route.params.to_path) {
              console.log(this.$route.params.to_path);
              this.$router.push({ path: this.$route.params.to_path });
            } else {
    ...
    forgotPassword: function() {
      firebase
        .auth()
        .sendPasswordResetEmail(this.login_input_username)
        .then(() => {
          this.errormsg = "";
