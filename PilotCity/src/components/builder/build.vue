...
<div class="main-bar-1 col-1 p-0 m-0 pt-4">

        <div class="connect-bar p-auto m-auto">CONNECT
            <div class="connect-bar-button">
                <i class="fas fa-question" id="faq_icon"></i>
            </div>

            <div class="connect-bar-button">
                <i class="material-icons" id="office_hours_icon"> access_time </i>
            </div>

            <div class="connect-bar-button">
                <i class="material-icons" id="messaging_icon"> message </i>
            </div>

            <div class="connect-bar-button">
                <i class="fas fa-bus" id="field_trip_icon"></i>
            </div>

            <div class="connect-bar-button">
                <i class="fas fa-user-circle" id="visit_icon"></i>
            </div>
...
<div class="main-bar-2 col-8 m-0 p-0 pt-3">
        ...
        <div class="builder-frame d-flex flex-column container flex-wrap mt-0 pt-0 pr-0 pb-2 pl-0">
            ...
            <div class="active-tab-highlight-2 col-4 d-flex flex-row">xx</div>

            <div class="builder-frame-tabs d-flex flex-row">
                <div class="builder-tab deactivated-tab-1 col-4 pt-3">Challenge</div>
                <div class="builder-tab active-tab col-4 pt-3">Build</div>
                <div class="builder-tab deactivated-tab-2 col-4 pt-3">Experience</div>
            </div>

            <div class="builder-body d-flex flex-column p-5">


<i class="far fa-edit ml-auto mr-3" id="build_edit_icon"></i>
<div id="accordion m-auto">

  <div class="module-card-1 card">
    <div class="module-card-header-1 card-header" id="headingOne">
      <h5 class="mb-0">
        <div class="d-flex flex-row">
            <i class="fas fa-brain mt-auto mb-auto mr-3 module_icon"></i>
             <button class="module-button-1 btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Ideate</button>
            <i class="fas fa-bars ml-auto" id="module_drag_function"></i>
        </div>
      </h5>
    </div>
    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="module-card-body-1 card-body">
        Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
      </div>
    </div>
  </div>
  <div class="module-card-2 card">
    <div class="module-card-header-2 card-header" id="headingTwo">
      <h5 class="mb-0">
        <div class="d-flex flex-row">
            <i class="fas fa-sitemap mt-auto mb-auto mr-3 module_icon"></i>
             <button class="module-button-2 btn btn-link" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">Business</button>
            <i class="fas fa-bars ml-auto" id="module_drag_function"></i>
        </div>
        </button>
      </h5>
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
      <div class="module-card-body-2 card-body">
        Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
      </div>
    </div>
  </div>
  <div class="module-card-3 card">
    <div class="module-card-header-3 card-header" id="headingThree">
      <h5 class="mb-0">
        <div class="d-flex flex-row">
            <i class="fab fa-accusoft mt-auto mb-auto mr-3  module_icon"></i>
             <button class="module-button-3 btn btn-link" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">Prototype</button>
            <i class="fas fa-bars ml-auto" id="module_drag_function"></i>
        </div>
      </h5>
    </div>
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
      <div class="module-card-body-3 card-body">
        Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
      </div>
    </div>
  </div>
...
<div class="main-bar-3 col-3 m-0 p-0 pt-4">
        ...
        <div class="details-bar flex-column">
            ...
            <div class="details-bar-title">Challenge</div>
            <div class="details-bar-display-medium">Smart Autonomous Drones</div>
...
#module_drag_function {
    padding-top:4px;
    color: #dbdcde;
}

#module_drag_function:hover {
    padding-top:4px;
    color: #dbdcde;
    cursor: pointer;
}

#module_drag_function:active {
    padding-top:4px;
    color: #404041;
    cursor: pointer;
}
