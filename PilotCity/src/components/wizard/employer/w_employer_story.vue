<template>
    <div class="container-fluid mt-5 mx-auto Raleway">
        ...
        <div class="d-flex flex-row justify-content-center mr-5" >
            <div class="p-2 align-self-center">
                <p class="teacher-story">and I am a liaison at</p>
            </div>
            <div class="p-2 align-self-start">
                <input type="text" placeholder="Organization Name" class="badge-pill pc-button" v-model="school_name">
            </div>
            <div class="p-2 align-self-center">
                <p class="teacher-story">and my position is </p>
            </div>
        </div>
        <div class="d-flex flex-row justify-content-center">
            <div class="p-2 align-self-start">
                <input type="text" placeholder="Position Name" class="badge-pill pc-button" v-model="school_district">
            </div>
            <div class="p-2 align-self-center">
