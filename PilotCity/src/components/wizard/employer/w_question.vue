                ...
                <div class="input-group mb-2">
                        <div class="input-group-prepend">
                            <div class="pc-input-group-text">
                                <h3 class="pc-keyword-title">Problems</h3>
                            </div>
                        </div>
                        <input type="text" class="pc-input-box" placeholder="Type here to enter problems you would have students solve" @keypress.enter.prevent="input_addtoIDB(i_keyword,selected_ikeywords)" v-model="i_keyword">
                    </div>
