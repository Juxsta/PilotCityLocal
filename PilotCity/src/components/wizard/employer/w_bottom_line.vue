                ...
                <div class="input-group mb-2">
                        <div class="input-group-prepend">
                            <div class="pc-input-group-text">
                                <h3 class="pc-keyword-title">What's your bottom line?</h3>
                            </div>
                        </div>
                        <input type="text" class="pc-input-box" placeholder="Enter keywords that describe your bottom line" @keypress.enter.prevent="input_addtoIDB(i_keyword,selected_ikeywords)" v-model="i_keyword">
                    </div>
    ...
    <div class="space-between-tagging">
            ...
            <div class="pc-panel-tagspanel" >
                <div class="input-group mb-2">
                        <div class="input-group-prepend">
                            <div class="pc-input-group-text">
                                <h3 class="pc-keyword-title">How are you doing it now?</h3>
                            </div>
                        </div>
                        <input type="text" class="pc-input-box" placeholder="Enter keywords that describe your current strategies and initiatives" @keypress.enter.prevent="input_addtoIDB(i_keyword,selected_ikeywords)" v-model="i_keyword">
                    </div>
        <hr class="frame-line-break" />
            <div class="ml-3">
                <span class="badge badge-pill badge-primary tag-capitalize pr-3 ml-1 mr-1 mb-1 mt-1" v-for="(keyword,index) in selected_ikeywords" :key="keyword + index" :class="colors[index%7]">
